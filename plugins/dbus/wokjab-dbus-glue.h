...
#ifndef __dbus_glib_marshal_wokjab_MARSHAL_H__
#define __dbus_glib_marshal_wokjab_MARSHAL_H__
...
extern void dbus_glib_marshal_wokjab_BOOLEAN__STRING_STRING_POINTER_POINTER (GClosure     *closure,
                                                                             ...
                                                                             gpointer      marshal_data);
void
dbus_glib_marshal_wokjab_BOOLEAN__STRING_STRING_POINTER_POINTER (GClosure     *closure,
                                                                 GValue       *return_value,
                                                                 guint         n_param_values,
                                                                 const GValue *param_values,
                                                                 gpointer      invocation_hint,
